						...
						<div class="adam-reward-editor__sidebar">
							<section class="adam-reward-editor__section adam-reward-editor__section--accordion is-open" data-adam-background-controls>
								...
								<div class="adam-reward-editor__field-grid adam-reward-editor__field-grid--compact">
									...
									<label data-adam-background-mode-group="gradient image"><span><?php esc_html_e( 'Origem do gradiente', 'adam-membership' ); ?></span><select name="visual_style[gradient_origin]" data-adam-style="gradient_origin"><?php $this->render_gradient_origin_options( (string) $resolved_style['gradient_origin'] ); ?></select></label>
