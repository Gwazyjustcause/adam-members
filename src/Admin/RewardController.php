					...
					<div class="adam-reward-editor__workspace adam-reward-editor__conditional-field<?php echo $uses_visual_editor ? '' : ' is-hidden'; ?>" data-adam-digital-workspace>
						<div class="adam-reward-editor__controls">
							...
							<section class="adam-reward-editor__section adam-reward-editor__section--accordion is-open" data-adam-style-controls>
								...
								<div class="adam-reward-editor__accordion-body">
								<p class="adam-reward-editor__section-copy"><?php esc_html_e( 'Configura apenas a moldura do cartao, sem alterar o fundo, a geometria ou a estrutura do cartao.', 'adam-membership' ); ?></p>
								<div class="adam-reward-editor__field-grid">
									...
									<label data-adam-frame-group="simple"><span><?php esc_html_e( 'Cor da moldura', 'adam-membership' ); ?></span><input class="adam-color-picker" type="text" name="visual_style[frame_color]" value="<?php echo esc_attr( (string) $resolved_style['frame_color'] ); ?>" data-adam-style="frame_color"></label>
									...
									<label class="adam-reward-editor__slider-field" data-adam-frame-group="simple metallic gradient"><span><?php esc_html_e( 'Espessura da moldura', 'adam-membership' ); ?></span><input type="range" min="0" max="16" name="visual_style[frame_thickness]" value="<?php echo esc_attr( (string) $resolved_style['frame_thickness'] ); ?>" data-adam-style="frame_thickness"><small data-adam-value-for="frame_thickness"><?php echo esc_html( (string) $resolved_style['frame_thickness'] ); ?>px</small></label>
								</div>
								</div>
							</section>
