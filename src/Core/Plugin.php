...
use AdamMembership\Document\MemberDocumentHistoryRepository;
use AdamMembership\Document\MemberDocumentHistorySchema;
...
final class Plugin {
	...
	private function register_modules(): void {
		...
		$member_document_history     = new MemberDocumentHistoryService( $settings, $renewal_repository, $private_document_repository, $member_document_history_repository, $private_document_storage, $logger );
