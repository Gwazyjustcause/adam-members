...
use AdamMembership\Member\CardImageRenderer;
...
final class Plugin {
	...
	private function register_modules(): void {
		...
		$card_image_renderer = new CardImageRenderer();
		...
		$cards              = new CardService( $members, $settings, $logger, $card_cosmetics, $rewards, $card_image_renderer );
